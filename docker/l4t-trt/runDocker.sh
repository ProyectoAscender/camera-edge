...
docker run --runtime nvidia --name edge05 -p 8080:8080 -p 5000:5000 -p 5000:5000/udp -p 8884:8884 -p 8884:8884/udp -p 5001:5001 -p 5001:5001/udp -p 8884:8884 -p 8884:8884/udp  --network host -v ~/camera-edge/:/root/repos/camera-edge/ -v /root/repos/camera-edge/trt-detect -v /root/repos/camera-edge/build -v /mnt/b2drop/smartCity:/root/b2drop -it --entrypoint="/bin/bash" $IMAGE 
# docker run -it --runtime nvidia --name edge05 -p 8080:8080 -p 5000:5000 -p 5000:5000/udp -p 8884:8884 -p 8884:8884/udp -p 5001:5001 -p 5001:5001/udp -p 8884:8884 -p 8884:8884/udp  --network host -v /mnt/b2drop/smartCity:/root/b2drop  --entrypoint="/bin/bash" --rm $IMAGE 
