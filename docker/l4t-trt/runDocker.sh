IMAGE=registry.gitlab.bsc.es/ppc/benchmarks/smart-city/camera-edge:r8.6.2-devel
# -v /root/repos/camera-edge/models 
docker run -d --rm --name edge_$USER --runtime nvidia -p 8080:8080 -p 5000:5000 -p 5000:5000/udp -p 8884:8884 -p 8884:8884/udp -p 5001:5001 -p 5001:5001/udp -p 8884:8884 -p 8884:8884/udp  --network host -v ~/camera-edge/:/root/repos/camera-edge/ -v /root/repos/camera-edge/trt-detect -v /root/repos/camera-edge/build -v /mnt/b2drop/smartCity:/root/b2drop $IMAGE  /bin/bash ../scripts/runEdge.sh 
